...
public class Rewards {
     ...
     *
     * @param p_           Playername
     * @param econ         Whether economy rewards are enabled
     * @param command      Whether command rewards are enabled
     * @param money_reward Amount of money to reward if economy rewards are enabled
     * @param cmd          Command to execute if command rewards are enabled
     */
     ...
     * @param p_                Playername
     * @param a                 Arena
     * @param players           Optional array of players to send win broadcast to
     * @param global_multiplier Money reward multiplier (default: 1)
     */
